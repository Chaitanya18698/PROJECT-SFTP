...
export class CommonService {
    ...
    update_implementors(body: any) {
        const url = AppSettings.API.UPDATE_IMPLEMENTORS;
        return this._apiservice.callApi({ url, method: 'POST', body });
    }

    update_clientUser(body: any) {
        const url = AppSettings.API.UPDATE_CLIENT;
        return this._apiservice.callApi({ url, method: 'POST', body });
    }
    ...
    get_login_details(body: any) {
        const url = AppSettings.API.LOGIN_DETAILS;
        return this._apiservice.callApi({ url, method: 'POST', body });
    }
